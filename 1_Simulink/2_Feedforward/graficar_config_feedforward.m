...
title('\textbf{Control en Config. Feedforward}','Interpreter','Latex', 'FontSize', 14)
hold off

% subplot(1,2,2)
% plot(out.tout, out.ruido_orig)
% grid on
% xlabel('Tiempo [s]','Interpreter','Latex')
% ylabel('Amplitud [u. r.]','Interpreter','Latex')
% title('Fuente de ruido','Interpreter','Latex')
% xlim([0 0.02])
